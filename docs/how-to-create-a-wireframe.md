...
- **Location:** `specs/views/<view-name>/portrait.png` and `landscape.png`
- **Naming:** Use the view's slug name (e.g., `document-reader`, `settings-view`)

```
specs/views/document-reader/
├── portrait.png
├── landscape.png
